...
def render_drivers_page():
    ...
    if df_master is None or df_master.empty:
        ...
        with col_dr2:
            ...
            min_robots = st.number_input("Min robot_count", min_value=0, value=0, step=1)
            max_robots = st.number_input("Max robot_count", min_value=0, value=10, step=1)
...
def render_quote_page():
    ...
    if not st.session_state["models_ready"]:
        ...
        product_familiarity_score = st.slider("Product familiarity (1–5)", 1, 5, 3)
        ...
        process_uncertainty_score = st.slider("Process uncertainty (1–5)", 1, 5, 3)
        ...
        complexity_score_1_5 = st.slider("Overall complexity (1–5)", 1, 5, 3)
